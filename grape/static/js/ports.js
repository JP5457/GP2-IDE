...
function setupEditor(id) {
	...
	svg.addEventListener("mousemove", (e) => {
		...
		let moveEvent = new CustomEvent("svgmousemove", {
			detail: position,
			bubbles: true,
		});
	...
	svg.addEventListener("click", (e) => {
		let position = getPosition(e, svg);
		let clickEvent = new CustomEvent("svgclick", {
			detail: position,
			bubbles: true,
		});
	...
	svg.addEventListener("dblclick", (e) => {
		let position = getPosition(e, svg);
		let dblclickEvent = new CustomEvent("svgdblclick", {
			detail: position,
			bubbles: true,
		});
	...
	svg.addEventListener("mousedown", (e) => {
		...
		switch (e.button) {
			case 0:
				downEvent = new CustomEvent("svgleftdown", {
					detail: position,
					bubbles: true,
				});
				break;
			...
			case 2:
				downEvent = new CustomEvent("svgrightdown", {
					detail: position,
					bubbles: true,
				});
				break;
		...
		if (downEvent != null) e.target.dispatchEvent(downEvent);
	});
	...
	svg.addEventListener("mouseup", (e) => {
		...
		switch (e.button) {
			case 0:
				upEvent = new CustomEvent("svgleftup", {
					detail: position,
					bubbles: true,
				});
				break;
			...
			case 2:
				upEvent = new CustomEvent("svgrightup", {
					detail: position,
					bubbles: true,
				});
				break;
		...
		if (upEvent != null) e.target.dispatchEvent(upEvent);
	});
